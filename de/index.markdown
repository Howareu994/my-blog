...
<header class="site-header">
    <div class="header-inner">
        ...
        <nav class="desktop-nav">
            ...
            <a class="page-link" href="{{ '/map/' | relative_url }}">🗺️ Skizzen</a>
            <a class="page-link" href="{{ '/about/' | relative_url }}">☕ Dossier</a>
            <a class="page-link lang-btn" href="{{ '/' | relative_url }}">🇨🇳 CN</a>
        </nav>
    </div>
</header>
    ...
    <div class="col-right">
        ...
        <div class="horizontal-scroll">
            <a href="{{ '/termin/' | relative_url }}" class="feature-card">
                ...
                <span class="feature-text">Begleitung<br>& Analoge Präsenz</span>
            </a>
            <a href="{{ '/consulting/' | relative_url }}" class="feature-card">
                <span class="feature-icon">🛋️</span>
                <span class="feature-text">Akut-Support <br>für seelische Resilienz</span>
            </a>
            <a href="{{ '/survival/' | relative_url }}" class="feature-card">
                <span class="feature-icon">🛟</span>
                <span class="feature-text">Der Berlin-<br>Überlebensleitfaden</span>
            </a>
        </div>
